var config = {
    ...
    accessToken: 'pk.eyJ1IjoibWFyY29uYXN1dG8iLCJhIjoiY2t3MmNkamhlMXRzdjJ1cWltaGE4M3g0bSJ9.OqKvDrRFKg8mDY8vTyj0rw',
    showMarkers: false,
    markerColor: '#3FB1CE',
    theme: 'dark',
    use3dTerrain: true,
    ...
    chapters: [
        {
            ...
            description: 'A tiny rural village and a former US airforce base \nhost a centre for asylum seekers refugees but \n just outside the barbed wire fence, on the abandoned runway \n there are rusty containers and shacks where people with dozens of different nationalities live. This is where Dina and Father Arcangelo (R.I.P. ❤️) work as voluteers. Slums and illegal camps like "La Pista" are sperad all around il Foggiano providing a constantly growing exploitable workforce.',
            location: {
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: '16,000 \nGhetto Rignano, Italy',
            image: 'https://st.ilfattoquotidiano.it/wp-content/uploads/2017/03/ghetto-rignano-675.jpg',
            description: 'It\'s been estimated that around 16,000 migrants live in Capitanata plain, the greatest majority lives in slums built in the fields. They have bars, shops, restaurants, churches and brothels. People pay a rent to those same migrants that built the shelters. \nUnfortunately, fires, violence and accidents are very frequent, causing destructions and deaths. An invisible, parallel world.',
            location: {
                center: [15.565071783735746, 41.59073485185061],
                zoom: 16,
                pitch: 0,
                bearing: 0
            },
